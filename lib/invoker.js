...
var prepareInvoke = function(args, done) {
  ...
  if (!_.isBoolean(args.writeParameterFilesBeforePipeline)) args.writeParameterFilesBeforePipeline = true;
...
var invoke = function(args, done) {
  ...
  async.series([
    ...
    function(callback) {
      ...
      if (ctx.writeParameterFilesBeforePipeline) lastStream = lastStream.pipe(writeParamFilesStream);
